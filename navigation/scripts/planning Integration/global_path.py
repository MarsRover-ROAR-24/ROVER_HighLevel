...
class GlobalPathPublisher:
    def __init__(self):
        ...
        self.original_waypoints = [(x, x) for x in range(11)]  # (0, 0) to (10, 10)
        self.waypoints = self.interpolate_waypoints(self.original_waypoints, max_distance=0.5)
    ...
    def publish_path(self, event):
        ...
        rospy.loginfo("Published global path with {} points".format(len(self.waypoints)))
