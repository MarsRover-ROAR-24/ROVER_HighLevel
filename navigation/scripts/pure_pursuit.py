...
class Turtle:
        ...
        def __init__(self):
                ...
                self.fig, (self.ax1) = plt.subplots(1,figsize=(12, 6))
                ...
                self.ax1.set_xlim(0, 15)  # Set x-axis limits from -10 to 10
                self.ax1.set_ylim(0, 15)  # Set y-axis limits from -10 to 10
                self.waypoints_x = []
                self.waypoints_y = []
